...
public class AppJobData {
    ...
    private static final Logger logger = Logger.getLogger(AppJobData.class.getName());
    ...
    public AppJobData(String conf, JSONObject runtime){
   ...
   private void load() {
      try {
        File fdef = FileUtils.toFile(AppJobData.class.getResource("job.json"));
        ...
        logger.info("AppJobData loaded");
      } catch (IOException ex) {
        Logger.getLogger(AppJobData.class.getName()).log(Level.SEVERE, null, ex);
      }
    }
