...
public class InitServlet extends HttpServlet {
  ...
  public static String CONFIG_DIR = ".inprove-search";
  
  //Directory where cant override configuration  
  public static String SYSTEM_PROPERTY_NAME = "inprove_app_dir";
  ...
  public void init() throws ServletException {
    ...
    if (System.getProperty(SYSTEM_PROPERTY_NAME) != null) {
      CONFIG_DIR = System.getProperty(SYSTEM_PROPERTY_NAME);
